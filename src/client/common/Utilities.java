...
/*	// convert from web element HotelProfile, to internal used HotelProfile
	public static common.HotelServerTypes.HotelProfile 
		fromWebElem(HotelProfile prof_elem) {
		
		common.HotelServerTypes.HotelProfile prof = 
				new common.HotelServerTypes.HotelProfile();
		
		prof.shortName = prof_elem.getShortName();
		prof.fullName = prof_elem.getFullName();
		prof.totalRooms = new EnumMap 
				<common.HotelServerTypes.RoomType, Integer> (common.HotelServerTypes.RoomType.class);
