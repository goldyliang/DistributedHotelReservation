...
import server.DataTypes.*;
import server.impl.ReserveRecords.IRecordOperation;
import server.impl.roomcounts.RoomCounts;
import server.impl.roomcounts.RoomCountsFactory;
import serverws.HotelServerWS;

public class HotelServerImpl implements HotelServer, Runnable {
...
/*    public static class AddressPort {
    ...
    public HotelServerImpl ( HotelProfile prof, int queryPort) {
   ...
   public long loginAsManager (String managerID, String passWord) {
    ...
    public static void oldMain (String args[]) {
        ...
        HotelServerImpl server = new HotelServerImpl(prof, queryPort);
    ...
    public static HotelServerImpl createServer (String configFile) {
