                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // CHotelServerInterface/CIHotelServer/reserveHotel
       {
         ...
         org.omg.CORBA.IntHolder reservationID = new org.omg.CORBA.IntHolder ();
         int $result = (int)0;
         $result = this.reserveHotel (guestID, roomType, checkInDate, checkOutDate, reservationID);
         out = $rh.createReply();
         out.write_long ($result);
         CHotelServerInterface.CReserveIDHelper.write (out, reservationID.value);
         break;
       }
       ...
       case 5:  // CHotelServerInterface/CIHotelServer/transferReservation
       {
         ...
         org.omg.CORBA.IntHolder newResID = new org.omg.CORBA.IntHolder ();
         int $result = (int)0;
         $result = this.transferReservation (guestID, reservationID, roomType, checkInDate, checkOutDate, targetHotel, newResID);
         out = $rh.createReply();
         out.write_long ($result);
         CHotelServerInterface.CReserveIDHelper.write (out, newResID.value);
         break;
       }
