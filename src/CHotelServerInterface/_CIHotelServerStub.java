...
public class _CIHotelServerStub extends org.omg.CORBA.portable.ObjectImpl implements CHotelServerInterface.CIHotelServer
{
  ...
  public int reserveHotel (String guestID, CHotelServerInterface.CRoomType roomType, CHotelServerInterface.CDate checkInDate, CHotelServerInterface.CDate checkOutDate, org.omg.CORBA.IntHolder reservationID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                int $result = CHotelServerInterface.CERROR_CODEHelper.read ($in);
                reservationID.value = CHotelServerInterface.CReserveIDHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
  ...
  public int transferReservation (String guestID, int reservationID, CHotelServerInterface.CRoomType roomType, CHotelServerInterface.CDate checkInDate, CHotelServerInterface.CDate checkOutDate, String targetHotel, org.omg.CORBA.IntHolder newResID)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                $in = _invoke ($out);
                int $result = CHotelServerInterface.CERROR_CODEHelper.read ($in);
                newResID.value = CHotelServerInterface.CReserveIDHelper.read ($in);
                return $result;
            } catch (org.omg.CORBA.portable.ApplicationException $ex) {
                $in = $ex.getInputStream ();
                String _id = $ex.getId ();
